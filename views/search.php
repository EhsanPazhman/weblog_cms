        ...
        <div class="row">
                <?php foreach ($searchResults as $searchResult): ?>
                    <div class="col-12 col-lg-4 mt-3">
                        <div class="post-item">
                            <?= "<img src='".siteUrl("admin/assets/img/$searchResult->img")."' alt='' style='width: 100%;'>" ?>
                            <div class="hovershow">
                                <div class="hover-image-post d-none d-lg-flex">
                                </div>
                                <a href="<?= siteUrl('views/single.php') ?>?postId=<?= $searchResult->id ?>" class="more-opst btn d-none d-lg-flex">مشاهده ی مقاله</a>
                            </div>
                            <div class="post-caption">
                                <p>
                                    <a href=""><?= $searchResult->title ?></a>
                                </p>
                                <span><?= limit_words($searchResult->description,12) ?></span>
                                <br><br>
                                <span class="seen-post">
                                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-eye-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z" />
                                    <path fill-rule="evenodd" d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z" />
                                </svg><?= countTable('views',"WHERE article_id = $searchResult->id")[0]->count ?>
                            </span>
                                ...
                                </svg><?= countTable('comments', "WHERE article_id =$searchResult->id")[0]->count ?></span>
                                <span class="float-left post-m">
                                <a href="">
                                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-person-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
                                    </svg> <?= $searchResult->author ?></a>
                            </span>
                            </div>
                        </div>
                    </div>
