    ...
    <div class="row">
        <div class="post-page">
            <div class="image-post">
                <?= "<img src='" . siteUrl("admin/{$post[0]->img}") . "' alt='' style='width: 100%;'>" ?>
            </div>
            <div class="information-post">
                ...
                <div>
                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-calendar2-date-fill"
            ...
            <div class="pt-4">
                <?php if (loginCheck()) : ?>
                    <form action="<?= siteUrl('') ?>?action=addComment&id=<?= $post[0]->id ?> " method="post">
                        <textarea name="comment" class="form-control" id="floatingTextarea"
                    ...
                    <?php foreach ($postComments as $comment): ?>
                        <div class="comment-item">
                            <div class="comment-image">
                                <img src="../assets/image/28159_d2db946f-3840-8eeb-66c2-39f399afce2e_رضا_الفت.jpg"
                                     alt="">
                            </div>
